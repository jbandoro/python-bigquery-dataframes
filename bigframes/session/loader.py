...
class GbqDataLoader:
    ...
    def read_gbq_table(
        ...
        *,
        ...
        if (
            isinstance(table, bq_data.GbqNativeTable)
            and (table.metadata.location or "").casefold()
            != self._storage_manager.location.casefold()
        ):
            raise ValueError(
    ...
    def _get_table_metadata(
        ...
        *,
        ...
        elif bf_read_gbq_table.is_iceberg_table(table_id):
